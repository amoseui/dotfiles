...
# Personal machines attach the private submodule; company forks leave it
# uninitialized and get the public links only.
if [ -f "$DOTFILES_PATH/private/link.sh" ]; then
    bash "$DOTFILES_PATH/private/link.sh"
fi
